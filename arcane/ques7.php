...
<body>
	...
	<div class="level">
		<div class="ques">
			<img src="arcane pics/cinema2.jpg">
		</div>
		
		<div class="ans">
		<form method="post">
			<input type="text" placeholder="Your answer" name="ans7" id="ans7" autocomplete="off"><br><br>
	...
	<?php
			...
			{
				$check=$_POST["ans7"];
				if ($_POST["ans7"] == 'jameswonghowe'){
				$qry = "UPDATE signup SET ans7='$check', score='8' WHERE mail='$username'";
