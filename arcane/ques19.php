...
<body>
	...
	<div class="level">
		...
		<div class="ans">
		<form method="post">
			<input type="text" placeholder="Your answer" name="ans19" id="ans19" autocomplete="off" ><br><br>
	...
	<?php
			...
			<?php
			if(isset($_POST['ans19']))
			{
				$check=$_POST["ans19"];
				if ($_POST["ans19"] == 'niue'){
				$qry = "UPDATE signup SET ans19='$check', score='20' WHERE mail='$username'";
